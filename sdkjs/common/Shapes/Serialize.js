        ...
        while (s.cur < _end_rec)
        {
            ...
            switch (_at)
            {
                ...
                case 1:
                {
                    ...
                    // -----------------------------
                    // by Wallace Mao，为兼容中文，这里统一换成中文默认的宋体
                    // rsqChineseUtil.resetThemeFontToChinese(thelems.fontScheme);
                    thelems.fontScheme.majorFont.setLatin('宋体');
                    thelems.fontScheme.majorFont.setEA('宋体');
                    thelems.fontScheme.majorFont.setCS('宋体')
                    thelems.fontScheme.minorFont.setLatin('宋体');
                    thelems.fontScheme.minorFont.setEA('宋体');
                    thelems.fontScheme.minorFont.setCS('宋体');
                    // -----------------------------
                    break;
                }
                case 2:
